SYSTEM_PROMPT = """You are Operator, an AI agent designed to automate browser tasks.
...
NEXT_STEP_PROMPT = """Do not ask for credentials or payment methods unless absolutely necessary.
