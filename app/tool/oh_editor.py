try:
    ...
    # If the package isn't installed, install it only when needed
    subprocess.check_call([sys.executable, "-m", "pip", "install", "openhands-aci"])

    # Now that it's installed, you can safely import it
    from openhands_aci import file_editor
